...
public class DeposerRequete {

    @XmlElement(name = "CityName", namespace = "http://www.superwebservice.com/publictypes")
    protected String cityName;
    @XmlElement(name = "CountryName", namespace = "http://www.superwebservice.com/publictypes")
